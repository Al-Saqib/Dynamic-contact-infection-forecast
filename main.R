...
## Author: Mr. Ashleigh C. Myall
##
## Copyright (c) Ashleigh C. Myall 2022
## Email: a.myall19@imperial.ac.uk
##
## ---------------------------
##
## Notes: R/ is the folder for scripts that contain R 
##        functions. All functions are documented with roxygen2 syntax.
##
## ---------------------------
...
stat.df = preProRollingWind(pathwaysWithTests,  # Patient pathways with tests (when a patient become positive)
                  staticVars,         # Static variables (i.e. age, gender, ...)
                  contextualVars,     # Background contextual variables (hospital infection numbers)
                  feature_n = 5,     # Time window size to compute variables over
                  prediction_n = 5)   # Forecasting horizon
